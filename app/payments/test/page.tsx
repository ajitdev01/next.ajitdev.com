...
export default function TestPaymentsListPage() {
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <Breadcrumbs
            items={[
              ...
              { name: "Test Payments Explorer", url: "/payments/test" },
            ]}
          />

          <Link
            href="/payments/self"
            className="inline-flex items-center gap-1.5 rounded-xl bg-slate-950 px-3.5 py-2 text-xs font-semibold text-white shadow-xs hover:bg-slate-800 transition active:scale-95 w-fit"
          >
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white/80 px-2.5 py-0.5 text-[11px] font-semibold text-slate-700 shadow-2xs mb-1">
                  ...
                  <span>Razorpay Live Activity</span>
                </div>
                <h1 className="text-2xl sm:text-3xl font-black text-slate-950 tracking-tight">
                  Test Payments Explorer
                </h1>
                <p className="text-xs sm:text-sm text-slate-500">
                  Real-time transaction history from Razorpay Gateway & MongoDB Atlas.
                </p>
              </div>
            </div>
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-xs">
              ...
              <div className="flex items-center gap-1.5 mt-1">
                ...
                <span className="text-xs font-bold text-slate-800">Razorpay Test</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-3xl border border-dashed border-slate-300 bg-white p-12 text-center">
            ...
            <p className="mt-1 text-xs text-slate-500 max-w-sm mx-auto">
              {search
                ...
                : "No payments recorded yet in this category. Make your first test payment to see it here live."}
            </p>
            <Link
              href="/payments/self"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs">
            ...
            >
              ...
              <div className="w-full rounded-2xl border border-slate-200 bg-slate-50/70 p-4 space-y-2.5 text-xs text-slate-700 mt-2">
                ...
                {activeReceipt.notes?.customerName && (
                  <div className="flex items-center justify-between py-1 border-b border-slate-200/60">
